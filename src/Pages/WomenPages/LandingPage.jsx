...
<Grid   item size={{xs:12}}  sx={{display:"flex",mt:{xs:10,md:16} }}>
...
<Grid  item size={{xs:10}} sx={{width:"80vw",height:{xs:"10vh",md:"35vh"},margin:"0px 10px"}}  >
...
<Grid item  size={{xs:1}}  sx={{display:"flex",justifyContent:"flex-start",alignItems:"center"}}  >
